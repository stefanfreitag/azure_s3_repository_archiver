...
| <code><a href="#azure-devops-repository-archiver.Archiver.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="azure-devops-repository-archiver.Archiver.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="azure-devops-repository-archiver.Archiver.with.parameter.mixins"></a>
